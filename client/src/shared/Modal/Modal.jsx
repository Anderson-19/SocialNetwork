...
import { PreviewImage } from '../../dashboard/components';
...
export const Modal = () => {
    ...
    return (
        <div className={`${isSideModalPost ? 'fixed flex justify-center items-center inset-0 bg-black bg-opacity-50 overflow-y-auto h-screen w-screen transition-all' : 'hidden'}`}>
